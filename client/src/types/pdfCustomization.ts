...
export const AVAILABLE_ARABIC_FONTS = [
  ...
  { value: "Cairo", label: "Cairo", url: "https://github.com/google/fonts/raw/main/ofl/cairo/Cairo-Regular.ttf" },
  { value: "Cairo-ExtraBold", label: "Cairo Extra Bold", url: "https://github.com/google/fonts/raw/main/ofl/cairo/Cairo-ExtraBold.ttf" },
  { value: "ElMessiri", label: "El Messiri", url: "https://github.com/google/fonts/raw/main/ofl/elmessiri/ElMessiri-Regular.ttf" },
  { value: "Lalezar", label: "Lalezar", url: "https://github.com/google/fonts/raw/main/ofl/lalezar/Lalezar-Regular.ttf" },
  { value: "Marhey", label: "Marhey", url: "https://github.com/google/fonts/raw/main/ofl/marhey/Marhey-Regular.ttf" },
] as const;
